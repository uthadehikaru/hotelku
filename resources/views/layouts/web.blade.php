...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" data-theme="light">
    <head>
        ...
        <link rel="icon" href="{{ asset('hotelku.png') }}" type="image/x-icon">
        ...
        <div class="flex flex-col min-h-screen">
            <header class="text-gray-600 body-font">
                <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    ...
                    <img src="{{ asset('hotelku.png') }}" alt="HotelKu" class="w-10 h-10">
                    <span class="ml-3 text-xl">{{ config('app.name' )}}</span>
                    </a>
                    <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
                    <a href="{{ url('/') }}" class="mr-5 hover:text-gray-900">Beranda</a>
                    </nav>
                    @guest
